...
def onAppStart(app):
    ...
    app.image = Image.open("images/skybackground.jpeg")
    ...
    app.image = Image.open(os.path.join(pathlib.Path(__file__).parent,"images/skybackground.jpeg"))
    ...
    app.image = openImage("images/skybackground.jpeg")
